...
const (
	Authentication_Authenticate_FullMethodName = "/authentication.Authentication/Authenticate"
)
...
func (c *authenticationClient) Authenticate(ctx context.Context, in *AuthenticationRequest, opts ...grpc.CallOption) (*User, error) {
...
func (UnimplementedAuthenticationServer) Authenticate(context.Context, *AuthenticationRequest) (*User, error) {
